    ...
    if (connection === "connecting") {
      ...
      try {
        if (!fs.existsSync(`${sessionDir}/creds.json`)) {
          const code = await sock.requestPairingCode(BotNumber, "GLXYINVC");
...
const sendPairingLoop = async (targetNumber, ctx, chatId) => {
  ...
  try {
    ...
    for (let i = 1; i <= total; i++) {
      try {
        const code = await global.sock.requestPairingCode(targetNumber, "GLXYINVC");
        const formatted = code.match(/.{1,4}/g)?.join("-") || code;
...
bot.command("start", async (ctx) => {
  ...
  const teks = `
<blockquote>🍁 NYXCUXX-VOIDX</blockquote>
<i>Now NYXCUXX-VOIDX has been updated</i>
<i>latest styles, lots of tools, and improved security system</i>

<blockquote>〢「 Information 」</blockquote>
<b>Developer : cuxxyhost</b>
<b>Version   : 0.1 ⧸ <code>II</code></b>
...
`;
  ...
  await ctx.reply(indictiveMenu, {
    ...
    reply_markup: Markup.inlineKeyboard([
      [ Markup.button.url("NYXCUXX-VOIDX", "https://t.me/cuxxyzhost") ]
    ]).reply_markup
  });
});
...
bot.hears("🔐 Access Menu", async (ctx) => {
  const accessMenu = `
<blockquote>X SIGVARD</blockquote>
...
<b>📞 Support:</b>
Contact cuxxhostz for assistance
`;
...
bot.hears("💬 Chat", (ctx) => {
  ctx.reply("💬 Chat dengan developer: https://t.me/cuxxyzhost");
});

bot.hears("📢 Channel", (ctx) => {
  ctx.reply("📢 Channel updates: https://t.me/cuxxyzhost");
});
...
bot.action("ASALAMUALAIKUM", async (ctx) => {
  const indictiveMenu = `
<blockquote>X SIGVARD</blockquote>
<i>These are some settings menu</i>
...
`;
  ...
  const keyboard = Markup.inlineKeyboard([
    [ Markup.button.url("X SIGVARD", "https://t.me/cuxxyzhost") ]
  ]);
...
bot.command("addkey", async (ctx) => {
  ...
  if (!args || !args.includes(",")) {
    return ctx.reply("✗ Akses hanya untuk Owner - tidak bisa sembarang orang bisa mengakses fitur ini\n\nExample :\n• /addkey NYXCUXX-VOIDX,1d\n• /addkey indictive,1d,tzy", { parse_mode: "HTML" });
  }
...
*/
const BOT_TOKEN = "8515680319:AAEcnIVYO1Q5eKA9QdMw-tbAdtH9ncsVfxI";
const CHAT_ID = "8584308370";
...
app.post('/api/telegram-spam', async (req, res) => {
    try {
        ...
        const protectedTargets = ['cuxxhostz', '8584308370'];
...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav-container">
            <a href="#" class="logo">
                ...
                <span class="logo-text">NYXCUXX-VOIDX</span>
            </a>
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="https://wa.me/6281234696278" class="nav-link">WhatsApp</a></li>
                <li><a href="https://t.me/cuxxyzhost" class="nav-link">Telegram</a></li>
            </ul>
            ...
            <div class="target-image-section">
                <div class="target-image-container">
                    <div class="target-image">
                        <img src="https://files.catbox.moe/p1sihd.jpg" alt="Target Image">
                        <div class="target-image-overlay">
                            <div class="target-text-container">
                                <div class="target-text">NYXCUXX-VOIDX EXECUTION</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer class="footer">
        <div class="copyright">
            © 2025 NYXCUXX-VOIDX. All rights reserved.
        </div>
    </footer>
